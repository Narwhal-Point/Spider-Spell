...
public class AimCameraSensitivityController : MonoBehaviour
{
    ...
    private const string aimSensitivityKey = "AimCameraSensitivityMultiplier";
    ...
    private void Start()
    {
        ...
        float sensitivityMultiplier = PlayerPrefs.GetFloat(aimSensitivityKey, 1f);
    ...
    public void ChangeSensitivity()
    {
        ...
        PlayerPrefs.SetFloat(aimSensitivityKey, sensitivitySlider.value);
        PlayerPrefs.Save();
    }
